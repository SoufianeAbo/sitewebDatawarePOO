        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full grid grid-flow-row grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 p-6" id = "TeamsTable">
                ...
                <?php
                    ...
                    foreach ($teams as $team) {
                        ...
                        echo '<a href="#" class="inline-flex items-center px-8 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 modifyBtn" data-id="'. $team['id'] .'">';
                        echo '<i class="fa-solid fa-gear mr-2"></i>Modify' ;
                        echo '</a>';
                        echo '<a href="removeTeam.php?id='. $team['id'] .'" class="inline-flex items-center px-8 py-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300">';
            ...
            <main class="w-full grid grid-flow-row grid-cols-1 md:grid-cols-2 lg:grid-cols-5 p-6 justify-center items-center hidden gap-5" id = "MembersTable">
                ...
                <?php
                    $equipeID = $_SESSION['equipeID'];
                    $currentMemberID = $_SESSION['id'];
                    $teamDetails = $teamObj->getTeamByIdScrum($equipeID, $currentMemberID);
